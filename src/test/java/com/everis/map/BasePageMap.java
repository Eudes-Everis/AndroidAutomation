...
public class BasePageMap {
	...
	protected AndroidDriver<MobileElement> driver = TestRule.getDriver();
	...
	public final Logger logger = Logger.getLogger(BasePageMap.class);
	...
	protected boolean waitNotPresent(By by, int timeOutInSeconds) {
		AndroidDriver<MobileElement> driver = TestRule.getDriver();
